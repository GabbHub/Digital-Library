...
/*
*Servlet per la gestione delle sessioni
*/
...
public class SecurityLayer {
    ...
    */  
    ...
    /**
     *questa funzione crea una sessione per l'utente
     *  
     * @param request servlet requet
     * @param username username dell'utente(email)
   ...
   /**
    *questa funzione serve per il logout, termina la sessione
